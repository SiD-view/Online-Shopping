				...
				<div class="col-md-3 logo_agile mb-4">
					<h1 class="text-center">
						<a href="${pageContext.request.contextPath}/home" class="font-weight-bold font-italic" style="font-size: 22px;">
							<img src="${pageContext.request.contextPath}/images/logo2.png" class="img-fluid" style="width: 80px;height: 80px; padding-right: 15px;">&nbsp;  iD-KART
						</a>
					</h1>
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="/product/search" method="post">
								...
								<button class="btn my-2 my-sm-0" type="submit">Go Search</button>
							</form>
						</div>
						<!-- //search -->
						<!-- cart details -->
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="${pageContext.request.contextPath}/product/all">View All Products</a>
						</li>
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="${pageContext.request.contextPath}/about">About Site</a>
						</li>	
						<li class="nav-item">
